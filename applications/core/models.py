...
class Vacancy(models.Model):
    ...
    has_experience = models.BooleanField(_('Опыт работы'), default=False)
    ...
    holiday_start_date = models.DateField(_('Дата начала каникул'), blank=True, null=True)
    holiday_end_date = models.DateField(_('Дата конца каникул'), blank=True, null=True)
